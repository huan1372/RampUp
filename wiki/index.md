...
- [Tensor Parallelism](techniques/tensor-parallelism.md) — splitting models across GPUs; ReaLB multimodal MoE EP load balancing via dynamic precision (1.29× layer speedup, implemented in vLLM, arXiv 2604.19503)
