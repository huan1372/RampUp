...
- [KV Cache Quantization](techniques/kv-cache-quantization.md) — sub-FP8 compression spectrum; TurboQuant 2.6–4.9×; IsoQuant SO(4) rotation family (research); sequential compression beyond Shannon limit (research)
