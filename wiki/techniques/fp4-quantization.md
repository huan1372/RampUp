...
tags: [quantization, memory, throughput, hardware, blackwell, moe, fp4, mxfp4, w4a4]
created: 2026-04-19
updated: 2026-04-19
sources: [raw/2026-04-19-vllm-prs-apr17-19.md, raw/vllm-benchmarks-2026.md, raw/2026-04-15-vllm-v019-release.md]
...
| | NVFP4 W4A16 | MXFP4 W4A4 |
|--|-------------|------------|
| Memory savings | ~4× vs BF16 weights | ~4× weights + ~4× activation memory during compute |
| Hardware requirement | SM120 or SM100 | SM100 only |
| Quality risk | Moderate | Higher (activations also quantized) |
| Production readiness | Available since v0.15.1 | Merged to main (April 2026), pre-release |
| MoE support | FlashInfer backend | New CUTLASS kernel (PR #37463) |

## When to Use

- **NVFP4 W4A16**: large MoE models on Blackwell where FP8 still doesn't fit; validate quality per model
...
- **Avoid on non-Blackwell**: FP4 without hardware TensorCore support degrades to software emulation; FP8 is preferred on H100/H200
